...
var mock_data_catalog_1 = require('./mock-data-catalog');
var CatalogService = (function () {
    function CatalogService(http) {
        this.http = http;
        this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        this.productsUrl = 'api/products';
        this.catalog = mock_data_catalog_1.CATALOG;
    }
    CatalogService.prototype.getCatalog = function () {
        return Promise.resolve(mock_data_catalog_1.CATALOG);
    };
    /* ------------------ */
    ...
    CatalogService.prototype.create = function (title, description, image, category) {
        return this.http
    ...
    CatalogService.prototype.delete = function (_id) {
